...
#erl -noshell -s bootstrap start_manager -name manager -verbose true 
#sleep 2

echo "Strating node 1..."
erl -noshell -s bootstrap start_node -name node_1$1 -node_id node_1$1 -port $1997 -verbose true &

echo "Strating node 2..."
erl -noshell -s bootstrap start_node -name node_2$1 -node_id node_2$1 -port $1998 -verbose true &

echo "Strating node 3..."
erl -noshell -s bootstrap start_node -name node_3$1 -node_id node_3$1 -port $1999 -verbose true
